        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-12">
          <div className="w-full md:w-1/2 text-center md:text-left">
            ...
            <p className="mt-6 text-lg text-white max-w-xl mx-auto md:mx-0">
              We offer a wide range of services to meet your needs. From video
              production to web development, we have you covered.
            </p>
            <div className="mt-8 hover:scale-102 transition cursor-pointer font-medium shadow-lg shadow-yellow-900/10">
              <Link
                to="/portfolio"
                className="bg-linear-to-r from-[#6c4120] to-[#f7d07f] text-white px-8 py-3 rounded-full"
              >
                Our Portfolio
              </Link>
            </div>
