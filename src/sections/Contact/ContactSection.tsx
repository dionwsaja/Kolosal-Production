        ...
        <div className="grid grid-cols-1 md:grid-cols-2">
          ...
          <div className="border-t md:border-t-0 md:border-l border-white/10 p-6 md:p-14">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                <label className="mb-4 block text-xs font-bold uppercase tracking-widest text-white/40">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <label className="flex items-center gap-3 p-3 rounded-xl border border-white/10 bg-white/5 hover:bg-white/10 transition cursor-pointer">
                    <input
                      type="checkbox"
                      name="services"
                      value="Personal Demand"
                      className="accent-orange-500"
                    />
                    <span className="text-white text-sm">Personal Demand</span>
                  </label>
                  ...
                  <label className="flex items-center gap-3 p-3 rounded-xl border border-white/10 bg-white/5 hover:bg-white/10 transition cursor-pointer">
                    <input
                      type="checkbox"
                      name="services"
                      value="Commercial & Product Visual"
                      className="accent-orange-500"
                    />
                    <span className="text-white text-sm">
              ...
              <div className="relative group">
                ...
                <button
                  ...
                  className="relative w-full flex items-center justify-center rounded-xl bg-white px-8 py-4 text-sm font-bold uppercase tracking-widest text-black transition-all hover:scale-[1.02] active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed"
                >
              ...
              {state.succeeded && (
                <div className="p-4 rounded-xl bg-green-500/10 border border-green-500/20 text-green-500 text-sm font-bold uppercase tracking-widest">
                  Message sent successfully!
                </div>
              )}

              {state.errors && (
                <div className="p-4 rounded-xl bg-red-500/10 border border-red-500/20 text-red-500 text-sm font-bold uppercase tracking-widest">
